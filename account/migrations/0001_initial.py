# Generated by Django 4.2.5 on 2023-10-01 15:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'permissions': [['deactivate_user', 'can deactivate user'], ['print_user', 'can print user'], ['import_user', 'can import user'], ['export_user', 'can export user']],
            },
        ),
    ]
